 ...
 * 			   具体功能可以查看文档
 */
public class Coolqplugins extends JcqAppAbstract implements ICQVer, IMsg, IRequest {
    ...
    public static void main(String[] args) {
        ...
        // 要测试主类就先实例化一个主类对象
        Coolqplugins demo = new Coolqplugins();
    ...
    public String appInfo() {
        ...
        String AppID = "com.lhb.coolqplugins";// 记住编译后的文件和json也要使用appid做文件名
        /**
